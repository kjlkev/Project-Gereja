...
<div class="container-fluid row">
    <div class="col-12 mt-4 text-center">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                ...
                @foreach ($avlsWithIbadahCount as $avl)
                    <tr>
                        <td>{{ $avl->fullname }}</td>
                        <td>{{ $avl->ibadah_count }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="col-6">
        <form method="get" action="{{ route('avl') }}" class="mb-4">
            @csrf
            <div class="form-group">
                <label for="avlMonthSelect">Select User:</label>
                <select name="avlMonthSelect" id="avlMonthSelect" class="form-control">
                    <option value="{{old('avlMonthSelect')}}">All Users</option>
                    @foreach($avlsWithIbadahCount as $avl)
                        <option value="{{ $avl->fullname }}">{{ $avl->fullname }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
            ...
            <a href="#" id="avlMonthChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Bar
                <i class="bi bi-bar-chart"></i>
            </a>
            <a href="#" id="avlMonthPieChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Pie
    ...
    <div class="col-6">
        <form method="get" action="{{ route('avl') }}" class="mb-4">
            @csrf
            <div class="form-group">
                <label for="avlYearSelect">Select User:</label>
                <select name="avlYearSelect" id="avlYearSelect" class="form-control">
                    <option value="{{old('avlYearSelect')}}">All Users</option>
                    @foreach($avlsWithIbadahCount as $avl)
                        <option value="{{ $avl->fullname }}">{{ $avl->fullname }}</option>
                    @endforeach
                </select>
            ...
            <button type="submit" class="btn btn-primary">Filter</button>
            <a href="#" id="avlYearChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Bar
                <i class="bi bi-bar-chart"></i>
            </a>
            <a href="#" id="avlYearPieChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Pie
                <i class="bi bi-pie-chart"></i>
            </a>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var link = document.getElementById('avlMonthChart');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var link = document.getElementById('avlMonthPieChart');
        // var queryString = '?yearData=' + JSON.stringify(yearData) + '&yearSelect=' + year;
        var monthChartUrl = 'https://quickchart.io/chart?w=500&h=300&c=' + encodeURIComponent(JSON.stringify(monthChart)) + '&format=pdf';
        // var yearChartUrl .= '&c=' . urlencode(json_encode(yearChart)) . '&format=pdf';
        // console.log(yearChartUrl);
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var link = document.getElementById('avlYearChart');
        // var queryString = '?yearData=' + JSON.stringify(yearData) + '&yearSelect=' + year;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var link = document.getElementById('avlYearPieChart');
        // var queryString = '?yearData=' + JSON.stringify(yearData) + '&yearSelect=' + year;
        var yearChartUrl = 'https://quickchart.io/chart?w=500&h=300&c=' + encodeURIComponent(JSON.stringify(yearChart)) + '&format=pdf';
        // var yearChartUrl .= '&c=' . urlencode(json_encode(yearChart)) . '&format=pdf';
        // console.log(yearChartUrl);
