...
<div class="container-fluid row">
    <div class="col-12 mt-4 text-center">
        ...
        <table class="table table-hover">
            ...
            <tbody class="text-center">
                ...
                @foreach ($pemusiksWithIbadahCount as $pemusik)
                    <tr>
                        <td>{{ $pemusik->fullname }}</td>
                        <td>{{ $pemusik->ibadah_count }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="col-6">
        <form method="get" action="{{ route('pemusik') }}" class="mb-4">
            @csrf
            <div class="form-group">
                <label for="pemusikMonthSelect">Select User:</label>
                <select name="pemusikMonthSelect" id="pemusikMonthSelect" class="form-control">
                    <option value="{{old('pemusikMonthSelect')}}">All Users</option>
                    @foreach($pemusiksWithIbadahCount as $pemusik)
                        <option value="{{ $pemusik->fullname }}">{{ $pemusik->fullname }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
            ...
            <a href="#" id="pemusikMonthChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Bar
                <i class="bi bi-bar-chart"></i>
            </a>
            <a href="#" id="pemusikMonthPieChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Pie
    ...
    <div class="col-6">
        <form method="get" action="{{ route('pemusik') }}" class="mb-4">
            @csrf
            <div class="form-group">
                <label for="pemusikYearSelect">Select User:</label>
                <select name="pemusikYearSelect" id="pemusikYearSelect" class="form-control">
                    <option value="{{old('pemusikYearSelect')}}">All Users</option>
                    @foreach($pemusiksWithIbadahCount as $pemusik)
                        <option value="{{ $pemusik->fullname }}">{{ $pemusik->fullname }}</option>
                    @endforeach
                </select>
            ...
            <button type="submit" class="btn btn-primary">Filter</button>
            <a href="#" id="pemusikYearChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Bar
                <i class="bi bi-bar-chart"></i>
            </a>
            <a href="#" id="pemusikYearPieChart" class="btn btn-danger">
                <i class="bi bi-file-earmark-pdf"></i>
                Export to Pie
                <i class="bi bi-pie-chart"></i>
            </a>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var monthChartLabels = userData.map(function(user) {
            return user.fullname;
        });
        var monthChartData = userData.map(function(user) {
        ...
        var link = document.getElementById('pemusikMonthChart');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var link = document.getElementById('pemusikMonthPieChart');
        // var queryString = '?yearData=' + JSON.stringify(yearData) + '&yearSelect=' + year;
        var monthChartUrl = 'https://quickchart.io/chart?w=500&h=300&c=' + encodeURIComponent(JSON.stringify(monthChart)) + '&format=pdf';
        // var yearChartUrl .= '&c=' . urlencode(json_encode(yearChart)) . '&format=pdf';
        // console.log(yearChartUrl);
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var link = document.getElementById('pemusikYearChart');
        // var queryString = '?yearData=' + JSON.stringify(yearData) + '&yearSelect=' + year;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var link = document.getElementById('pemusikYearPieChart');
        // var queryString = '?yearData=' + JSON.stringify(yearData) + '&yearSelect=' + year;
        var yearChartUrl = 'https://quickchart.io/chart?w=500&h=300&c=' + encodeURIComponent(JSON.stringify(yearChart)) + '&format=pdf';
        // var yearChartUrl .= '&c=' . urlencode(json_encode(yearChart)) . '&format=pdf';
        // console.log(yearChartUrl);
